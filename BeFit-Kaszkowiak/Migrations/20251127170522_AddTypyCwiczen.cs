...
namespace BeFit_Kaszkowiak.Migrations
{
    /// <inheritdoc />
    public partial class AddTypyCwiczen : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Opis = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    CzasTrwaniaSek = table.Column<int>(type: "int", nullable: false),
                    Powtorzenia = table.Column<int>(type: "int", nullable: false),
                    TypCwiczeniaId = table.Column<int>(type: "int", nullable: false),
                    SesjaId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cwiczenia", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Cwiczenia_Sesje_SesjaId",
                        column: x => x.SesjaId,
